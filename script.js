...
function executeSearch() {
    ...
    if (input.includes("حيدر وليد")) {
        ...
        document.getElementById('mohammed-obaidi').scrollIntoView({behavior: 'smooth'});
          ...
          else if (input.includes("ابراهيم الصميدعي")) { 
              resultsContainer.style.display = 'grid';
              document.getElementById('ibrahim-al-somaidai').style.display = 'contents';

              document.getElementById('ibrahim-al-somaidai').scrollIntoView({behavior: 'smooth'});
          }

          else if (input.includes("حسين عبد الحسين اللامي")) { 
              resultsContainer.style.display = 'grid';
              document.getElementById('meeeeeeeeeeeeeer').style.display = 'contents';

              document.getElementById('meeeeeeeeeeeeeer').scrollIntoView({behavior: 'smooth'});
          }

          else if (input.includes("علي الغرابي")) { 
              resultsContainer.style.display = 'grid';
              document.getElementById('ali-al-gorabi').style.display = 'contents';

              document.getElementById('ali-al-gorabi').scrollIntoView({behavior: 'smooth'});
          }

   else if (input.includes("فراس براق")) { 
              resultsContainer.style.display = 'grid';
              document.getElementById('fras-braq').style.display = 'contents';
          ...
          else if (input.includes("باقر القرة غولي")) { 
              resultsContainer.style.display = 'grid';
              document.getElementById('baqir-al-karagoli').style.display = 'contents';

              document.getElementById('baqir-al-karagoli').scrollIntoView({behavior: 'smooth'});
          }
...
const teachersList = ["حيدر وليد","احمد النعيمي","محمد العبيدي","محمد قاسم","عقيل الزبيدي","خضر الظاهر","حسين الهاشمي","سجاد العبيدي","حسين محمد","هاشم الغرباوي","شمس الادب","رفل الزبيدي"
        ...
        ,"ابراهيم الصميدعي","حسين عبد الحسين اللامي","علي الغرابي","فراس براق","وقاص الطائي","محمد الجنائي","باقر القرة غولي"];
